...
def main():
    ...
    if mode == 'train':
        ...
        model.model.layer4[0].conv1 = nn.Conv2d(256, 512, 3, 2, 1, bias=False)
        model.model.layer4[0].bn1 = nn.BatchNorm2d(512)
        model.model.layer4[0].conv2 = nn.Conv2d(512, 512, 3, 1, 1, bias=False)
        model.model.layer4[0].bn2 = nn.BatchNorm2d(512)
        model.model.layer4[0].downsample[0] = nn.Conv2d(256, 512, 1, 2, bias=False)
        model.model.layer4[0].downsample[1] = nn.BatchNorm2d(512)

        model.model.layer4[1].conv1 = nn.Conv2d(512, 512, 3, 1, 1, bias=False)
        model.model.layer4[1].bn1 = nn.BatchNorm2d(512)
        model.model.layer4[1].conv2 = nn.Conv2d(512, 512, 3, 1, 1, bias=False)
        model.model.layer4[1].bn2 = nn.BatchNorm2d(512)
        ...
        model.model.fc = nn.Linear(25088, batch_size, True)
        model.model.classifier = nn.Linear(batch_size, 2, True)
        model.model.add_module('')


        # Loss_fn, Optimizer, scheduler
        optimizer = optim.Adam(
            list(model.model.layer4[0].conv1.parameters()) + list(model.model.layer4[0].bn1.parameters()) +
            list(model.model.layer4[0].conv2.parameters()) + list(model.model.layer4[0].bn2.parameters()) +
            list(model.model.layer4[0].downsample[0].parameters()) + list(model.model.layer4[0].downsample[1].parameters()) +
            list(model.model.layer4[1].conv1.parameters()) + list(model.model.layer4[1].bn1.parameters()) +
            list(model.model.layer4[1].conv2.parameters()) + list(model.model.layer4[1].bn2.parameters()) +
            list(model.model.layer4[2].conv1.parameters()) + list(model.model.layer4[2].bn1.parameters()) +
            list(model.model.layer4[2].conv2.parameters()) + list(model.model.layer4[2].bn2.parameters()) +
            list(model.model.avgpool.parameters()) + list(model.model.fc.parameters()) +
            list(model.model.classifier.parameters())
            , lr=lr)
        ...
        print(test_model(model, dataloader, dataset_sizes))
